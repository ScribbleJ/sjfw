...
#define select_card() SD_SELECT_PIN.setValue(false)
#define unselect_card() SD_SELECT_PIN.setValue(true)

#define configure_pin_ss() SD_SELECT_PIN.setDirection(true)
